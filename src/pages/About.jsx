...
export default function About() {
  return (
    <div className="bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          <motion.h2
            ...
            className="text-base font-semibold text-primary dark:text-primary-dark tracking-wide uppercase"
          >
            About Us
          </motion.h2>
          <motion.p
      ...
      <div className="relative py-16 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900">
        <div className="absolute inset-0 opacity-10 dark:opacity-5">
          <div className="absolute inset-0 bg-[url('/path/to/subtle-pattern.svg')] bg-repeat"></div>
        </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20">
                ...
                <dl className="mt-6 space-y-4">
                  <div>
                    ...
                    <dd className="mt-1 text-gray-900 dark:text-white">
                      <a href="mailto:info@kakamega-alumni.com" className="hover:underline">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-gray-900 dark:text-white">
                      <a href="tel:+254 704 143990" className="hover:underline">
                        +254 704 143990
                      </a>
                    </dd>
                  </div>
