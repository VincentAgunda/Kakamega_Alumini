      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="bg-[#22344C] rounded-2xl shadow-md overflow-hidden p-8 mb-8">
          <div className="text-center">
            ...
            <motion.p
              ...
              className="mt-3 text-lg text-[#B6C2CC] max-w-3xl mx-auto"
            >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                viewport={{ once: true }}
                className="bg-white p-8 rounded-2xl shadow-lg border border-[#e8ecef]"
              >
                <div className="flex items-start mb-6">
                  <div className="bg-[#5E7B80] p-3 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <div className="ml-5">
                    <h2 className="text-2xl font-bold text-[#22344C]">
                      Our Mission
                    </h2>
                ...
                <div className="flex items-start">
                  <div className="bg-[#22344C] p-3 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="ml-5">
                    ...
                    <ul className="mt-3 space-y-3 text-gray-700">
                      <li className="flex items-start">
                        <span className="text-[#5E7B80] font-bold mr-2">•</span>
        ...
        <div className="py-16 px-4 sm:px-6 lg:px-8 bg-[#f0f2f5]">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-[#e8ecef]">
                ...
                <div className="p-8 bg-[#f0f2f5]">
                  ...
                  <dl className="mt-6 space-y-4">
                    <div>
                      ...
                      <dd className="mt-1 text-[#22344C]">
                        <a href="mailto:info@kakamega-alumni.com" className="hover:underline text-[#5E7B80] hover:text-[#4c6366]">
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-[#22344C]">
                        <a href="tel:+254 704 143990" className="hover:underline text-[#5E7B80] hover:text-[#4c6366]">
                          +254 704 143990
                        </a>
                      </dd>
                    </div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="mt-4 flex space-x-6">
                      <a href="#" className="text-[#5E7B80] hover:text-[#4c6366]">
