      ...
      >
        <div className="px-6 py-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Connect with former classmates and stay updated with school events
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-6">
            <Link
              to="/register"
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:focus:ring-offset-gray-800"
            >
              Register as Alumni
            </Link>
        ...
        <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
          <p className="text-xs text-gray-600 dark:text-gray-400 text-center">
            By joining, you agree to our <Link to="/terms" className="text-primary dark:text-primary-dark hover:underline">Terms</Link> and <Link to="/privacy" className="text-primary dark:text-primary-dark hover:underline">Privacy Policy</Link>
          </p>
        </div>
      </motion.div>
    </div>
